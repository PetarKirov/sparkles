...
#
# The gallery is hue's own output (`hue <dir> --twoslash --html --out`), pointed at
# the nix-built hue and the committed fixtures, with the grammar bundle wired up for
# full-fidelity highlighting + markdown docs. The output is a set of self-contained
# static HTML pages (inline CSS, no deps).
#
