...
Collie's event engine is its `kiss` dependency; the timer and transport examples
use that lower layer explicitly. The pinned Collie source requires the
[documented compatibility preparation](./running-examples.md#dependency-baselines)
on the current compiler. Queue and process adapters are application code, not
additional native Collie APIs.
...
<<< @/libs/event-horizon/tutorial/snippets/collie_timers.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_concurrency.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_deadline.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_tcp_echo.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_channel.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_file_read.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_exec.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_signal.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_spawn.d [collie]
...
<<< @/libs/event-horizon/tutorial/snippets/collie_retry.d [collie]
