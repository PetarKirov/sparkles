...
| --- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| R1  | Render core  | Frame buffer + diff — **architecture decided: 2-D cell-grid with a compact packed cell (§3.1, [baseline](./render-bench-baseline.md))**; build is open | open    | [Ratatui](../../research/tui-libraries/ratatui.md)/[libvaxis](../../research/tui-libraries/libvaxis.md)/[FTXUI](../../research/tui-libraries/ftxui.md)/[Notcurses](../../research/tui-libraries/notcurses.md) (cell); [Bubble Tea](../../research/tui-libraries/bubbletea.md) (line, rejected) |
