...
| Capability flags, profiles, per-target application                 | `sparkles:base` (`OutputCapabilities`, `TermCaps`), `sparkles:input` (`InputCapabilities`, `fromTerminal`), `sparkles:ui` (`TargetCapabilities`, profiles) | [`capabilities.md`](./capabilities.md)        |
