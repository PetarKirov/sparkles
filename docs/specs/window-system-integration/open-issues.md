...
| ------ | -------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| WSI-O1 | What is the smallest Event Horizon primitive that lets Win32 messages and AppKit's owned run loop share the scheduler without polling? | Win32 is answered by `runHostedOnce`/`tickHosted`, an IOCP completion-mirror event and a User32 combined wait; the AppKit `CFRunLoop`/kqueue half still needs its real spike. | M2 AppKit spike                           |
