...
| ID     | Section      | Contents                                                                                                                                                     |
| ------ | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `CFG3` | `appearance` | `theme`, `background` mode, `crt` (monitor shader: `enabled`, `tilt`, `magnify`, `curvature`, `scanlines`, `mask`, `chromaticAberration`, `vignette`, `flicker`, `brightness`, `lensRadius`, `lensPower`, `uiReactive`, `focusHalo`, `hoverGlow`, `selectionBloom`, `dividerTension`), fonts (`family`, `bold`, `italic`, `boldItalic`, `size`, `codepointMap[]`, `fontDir[]`), `window` (`width`, `height` in cells)   |
