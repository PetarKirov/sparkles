...
| ---- | ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- |
| TVU1 | **File explorer**            | filesystem tree (lazy dirs `TRV4`), file-type + git-status icons/badges (`TRV6`), open/reveal actions (`TRV7`) — the snacks-explorer use case; **entered by a directory CLI target** ([`SRC4`](./feature-requirements.md)). | partial — the TUI + GUI workspace panes ship with badges, filters and re-rooting; the HTML flavor (`XPL1`) is open | proposed FS adapter; `sparkles:build-primitives` walker; `SRC4` |
