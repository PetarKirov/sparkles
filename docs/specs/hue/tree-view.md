...
| ---- | ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------- |
| TVU1 | **File explorer**            | filesystem tree (lazy dirs `TRV4`), file-type + git-status icons/badges (`TRV6`), open/reveal actions (`TRV7`) — the snacks-explorer use case; **entered by a directory CLI target** ([`SRC4`](./feature-requirements.md)). | not started | proposed FS adapter; `sparkles:build-primitives` walker; `SRC4` |
