...
- **The preview gallery** is no longer a harness:
  ...
  **selection domains**. It lives in `sparkles:docs` (`libs/docs/src/sparkles/docs/page_shell.d`, unit-tested); the
