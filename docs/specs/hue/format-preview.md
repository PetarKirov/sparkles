...
| RUL5 | The column is **clamped** to a sane range; the keyboard nudge (`<`/`>`) goes through the **same clamp** as the drag (`DCK12`).                                                                                                                                                                             | full (`0642374c2`+`660f31915`)                                                                         | [containers.md](../ui/containers.md) `DCK12`        |
