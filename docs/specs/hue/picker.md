...
| `P4`      | The **grep** source: three modes, the definition classifier                                                                             | core shipped — `<leader>/` opens it in both hosts; regex mode, `PKL9`, `PKL10` and [`D9`](./viewer.md#known-divergences) remain | `PKS2`, `PKL5`, `PKL6`, `PKL8`, `PKC1`–`PKC17`       |
