...
_**Status:** shipped (G0–G4) · **Date:** 2026-07-29 · **Scope:** rendering a **set** of
...
> [!NOTE]
> Shipped end to end: the static gallery (`GAL1`–`GAL4`, `GAL6`–`GAL9`, `GAL11`) and the
