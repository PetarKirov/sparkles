...
| MDL5  | `FocusState.moved` always wraps and has no result meaning "the edge was reached, leave this order", so it can express a contained or modal scope but **not** a non-modal overlay that hands focus back. An additive result is required before `MDL4` ships.                                                                                                                                                                                                                                   | not started | `D9.C4` (narrowed)                                                                                              |
