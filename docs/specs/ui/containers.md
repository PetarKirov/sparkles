...
| DCK7  | **Wheel routing** is container-owned: a wheel event goes to the pane under the pointer, regardless of focus.                                                                                                                                                                                                                                                                                                                                           | partial — a wheel routes under the pointer, falling back to the focused pane over chrome; TUI adopted, the GUI still routes its own wheel                                                                                              | the twice-written pane-under-cursor blocks                                 |
