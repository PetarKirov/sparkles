...
| WGT12 | **Tree** — the exemplar; flat arena, opened set, guides, lazy children            | partial                                                                                                                                                                                                | `components/tree_widget.d` (`4e3ad035`); lazy children (`VMD5`) arrive with the explorer                                                   |
