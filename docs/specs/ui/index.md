...
| `libs/ui/src/sparkles/ui/widget.d`                      | [widgets](./widgets.md) — `WGT1`–`WGT6`; [containers](./containers.md) — `DCK15` (`pointerShape`, the declaration)                                                                                                                         |
| `libs/ui/src/sparkles/ui/display_list.d`                | [backends](./backends.md) — `TGT2`                                                                                                                                                                                                         |
| `libs/ui/src/sparkles/ui/state.d`                       | [state machines](./state-machines.md) — `STM1`–`STM13`; [input](./input.md) — `INP10`, `INP21` (the hit-list consumers); [containers](./containers.md) — `DCK15` (the shape composition); [anchored overlays](./popup.md) — `ANC3`, `ANC7` |
...
| `libs/input/src/sparkles/input/`                        | [input](./input.md) — `INP1`–`INP6`, `INP11`–`INP20`, `INP22` (`INP7`–`INP9` are the adapters', `INP10`/`INP21` the consumer's)                                                                                                            |
