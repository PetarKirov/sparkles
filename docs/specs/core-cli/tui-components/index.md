...
| #   | Item                          | Status  | Notes                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --- | ----------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A1  | Terminal capability detection | partial | The policy exists as private `prepareConsole` in `test-runner-impl/runner_impl.d` (`--no-colors` → `$NO_COLOR` → `isatty`; Windows UTF-8 code page + VT enable). Hoist into `term_caps.d` as `detectTermCaps` (§3). `terminalWidth() != 0` already covers tty-ness for the wrapping use case                                                                                                                                     |
