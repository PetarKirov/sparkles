...
| HTL14 | **Values render through `sparkles.base.text.writers.writeValue`** — the same vocabulary `styled_template` uses, so an `int`, a `Duration`, a `UniqueBuffer` or a `toString`-bearing type all interpolate without a caller-side `.text`.                                                                                                                                                                                                                                                                                                                   |
