...
| Similarity-paired token alignment | [delta](./delta.md) (Needleman–Wunsch + grouping bias), [VS Code](./vscode.md) (DP + boundary snapping), [Gerrit](./gerrit.md) (char Myers + hygiene passes), [Meld](./meld.md) (equal-run post-filter), [diffview-plus.nvim](./diffview-plus-nvim.md) (guarded two-stage), [WinMerge](./winmerge.md) (capped word engine) |
...
| 2022       | [ReviewStack](./reviewstack.md) (2022-11, with Sapling's open-sourcing): stack-aware review computed client-side                                                                                                   |
...
| 2025–2026  | AI review ([Graphite](./graphite.md) Diamond, 2025-03); difftastic-as-oracle editor integrations ([diffs.nvim](./diffs-nvim.md) `v0.1.0`, 2026-02-03)                                                              |
