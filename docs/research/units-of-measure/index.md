...
| **1994**  | **Kennedy** — _Dimension Types_ (ESOP); **Hart** — dimensioned matrices (SIAM)                     | ML Kit extension — the first implementation of dimension inference ([kennedy-types][kennedy])                          |
