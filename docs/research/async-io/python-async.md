...
[`selector_events.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/selector_events.py
[`Lib/selectors.py`]: https://github.com/python/cpython/blob/main/Lib/selectors.py
[`proactor_events.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/proactor_events.py
[`windows_events.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/windows_events.py
[`tasks.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/tasks.py
[`taskgroups.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/taskgroups.py
[`timeouts.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/timeouts.py
[`runners.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/runners.py
[`transports.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/transports.py
[`protocols.py`]: https://github.com/python/cpython/blob/main/Lib/asyncio/protocols.py
[`Modules/_asynciomodule.c`]: https://github.com/python/cpython/blob/main/Modules/_asynciomodule.c
[`src/trio/_core/_run.py`]: https://github.com/python-trio/trio/blob/main/src/trio/_core/_run.py
[`_core/_io_epoll.py`]: https://github.com/python-trio/trio/blob/main/src/trio/_core/_io_epoll.py
[`_core/_io_kqueue.py`]: https://github.com/python-trio/trio/blob/main/src/trio/_core/_io_kqueue.py
[`_core/_traps.py`]: https://github.com/python-trio/trio/blob/main/src/trio/_core/_traps.py
[`_timeouts.py`]: https://github.com/python-trio/trio/blob/main/src/trio/_timeouts.py
