// ImportC shim for the F02 resize demo (see ./app.d; copied from
// ../scaffold/c.c and extended with the xdg_toplevel fullscreen requests).
// Three jobs:
//
...
/* output == NULL lets the compositor pick the output (xdg-shell:
 * "If the surface doesn't cover the whole output, the compositor will
 * position the surface in the center of the output"). */
void wsi_toplevel_set_fullscreen(struct xdg_toplevel *t, struct wl_output *output)
{
    xdg_toplevel_set_fullscreen(t, output);
}
