...
| --- | ------------------ | ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- | -------------------- |
| R1  | manim              | one Bézier basis                                | community-Cairo is **cubic 4-pt** (separate colour arrays); ManimGL + community-GL are **quadratic 3-pt** (one structured array)                          | `vectorized_mobject.py` both trees          | ✓                    |
