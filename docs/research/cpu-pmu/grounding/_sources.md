...
comparison against libpfm4 git HEAD); Apple MacBook Pro M4 Max on-disk kpep plists
...
| `aarch64-darwin` (Apple MacBook Pro M4 Max) | Apple **M4 Max** (`Mac16,5`, die T6041, `hw.cpufamily 0x17d5b93a`), macOS **26.3.1** (25D771280a), **SIP enabled**, non-root (`sudo -n` unavailable); running kernel xnu-**12377.91.3** vs source drop xnu-**12377.1.9** (same 12377 base — version-skew note in the [macos ledger](./macos.md)); clang 21.0.0, xctrace 16.0 |
