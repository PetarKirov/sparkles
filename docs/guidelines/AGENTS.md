...
| `sparkles:reflection`           | `libs/reflection`           | Dependency-free structural reflection kernel: one closed `typeKindOf` classification, indexed field/property/`alias this` primitives with one-pass CTFE field and enum tables, and DbI type/value visitor shells whose hooks are all optional (cycle detection, transparent `SumType`, value-like wrapper rule); the property tree, text writers, query schemas, and serialization policies all dispatch on it — structure here, policy in the consumers ([docs](../libs/reflection/index.md))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
