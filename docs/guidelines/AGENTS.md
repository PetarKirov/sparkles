...
| `sparkles:wsi`                  | `libs/wsi`                  | Dependency-light native desktop window-system integration: unit-explicit geometry, generation-safe ids, typed errors/raw handles, lossless Regular events and a deterministic recording backend; native Win32 and AppKit lifecycle adapters share Event Horizon's only wait (User32/IOCP and CFRunLoop/kqueue), with IMM32 text input on Win32; native Wayland/X11 and remaining features follow `docs/specs/window-system-integration/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
