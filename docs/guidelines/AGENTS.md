...
| `sparkles:wsi`                  | `libs/wsi`                  | Dependency-light native desktop window-system integration core: unit-explicit geometry, generation-safe ids, typed errors and raw handles, lossless Regular events, backend selection, and a deterministic recording backend; native Wayland/X11/Win32/AppKit attachment follows `docs/specs/window-system-integration/`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
