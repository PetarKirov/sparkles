...
// The unittest build links `dub test`'s generated runner, which brings its own
// `main`; without this guard the test binary would *be* the tool and start a
// `wipe` (dry-run, but still probing every device).
