...
/// `docs/research/sanitizers/`, `docs/research/manim/`, and
/// `docs/research/tui-libraries/`).
@safe pure nothrow
private string[] standaloneExampleGlobs()
{
    return [
        ...
        "docs/research/tui-libraries/examples/*.d",
    ];
}
