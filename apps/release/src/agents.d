...
immutable AgentSpec[] agentRegistry = [
    AgentSpec("claude-code", "claude",   ["-p"],        PromptDelivery.arg),
    AgentSpec("codex",       "codex",    ["exec"],      PromptDelivery.arg),
    AgentSpec("gemini",      "gemini",   ["-p"],        PromptDelivery.arg),
    AgentSpec("copilot",     "copilot",  ["-p"],        PromptDelivery.arg),
    AgentSpec("opencode",    "opencode", ["run"],       PromptDelivery.arg),
    AgentSpec("aider",       "aider",    ["--message"], PromptDelivery.arg),
    AgentSpec("q",           "q",        ["chat"],      PromptDelivery.arg),
    AgentSpec("crush",       "crush",    ["run"],       PromptDelivery.arg),
    AgentSpec("goose",       "goose",    ["run", "-t"], PromptDelivery.arg),
    AgentSpec("amp",         "amp",      ["-x"],        PromptDelivery.arg),
];
