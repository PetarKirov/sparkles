...
immutable Binding[] galleryBindings = [
    ...
    // ── the Property page ────────────────────────────────────────────────
    bind(GalleryScope.pageProperty, chord(Key.down), GalleryCommand.propDown,
        "down"),
    bind(GalleryScope.pageProperty, chord(Key.up), GalleryCommand.propUp,
        "up"),
    bind(GalleryScope.pageProperty, chord(Key.right),
        GalleryCommand.propExpand, "expand"),
    bind(GalleryScope.pageProperty, chord(Key.left),
        GalleryCommand.propCollapse, "collapse / fold"),
    bind(GalleryScope.pageProperty, chord(Key.enter),
        GalleryCommand.propActivate, "toggle / edit"),
    bind(GalleryScope.pageProperty, chord('+'), GalleryCommand.propInc,
        "step up"),
    bind(GalleryScope.pageProperty, chord('='), GalleryCommand.propInc,
        "step up"),
    bind(GalleryScope.pageProperty, chord('-'), GalleryCommand.propDec,
        "step down"),
    bind(GalleryScope.pageProperty, chord('v'), GalleryCommand.propPreview,
        "preview drag"),
    bind(GalleryScope.pageProperty, chord('u', ShiftReq.no),
        GalleryCommand.propUndo, "undo"),
    bind(GalleryScope.pageProperty, chord('u', ShiftReq.yes),
        GalleryCommand.propRedo, "redo"),
    bind(GalleryScope.pageProperty, chord('/'), GalleryCommand.propFilter,
        "filter"),
    bind(GalleryScope.pageProperty, chord('n', ShiftReq.no),
        GalleryCommand.propMatchNext, "next match"),
    bind(GalleryScope.pageProperty, chord('n', ShiftReq.yes),
        GalleryCommand.propMatchPrev, "prev match"),
    bind(GalleryScope.pageProperty, chord('b'), GalleryCommand.propReveal,
        "reveal in base"),
    bind(GalleryScope.pageProperty, chord('p'), GalleryCommand.propPolicy,
        "read-only policy"),
    bind(GalleryScope.pageProperty, chord('e'), GalleryCommand.propExternal,
        "external write"),
    bind(GalleryScope.pageProperty, chord('o', ShiftReq.yes),
        GalleryCommand.propOpenAll, "open all"),
    bind(GalleryScope.pageProperty, chord('c', ShiftReq.yes),
        GalleryCommand.propCloseAll, "close all"),
    bind(GalleryScope.pageProperty, chord('r'), GalleryCommand.propReset,
        "reset demo"),
