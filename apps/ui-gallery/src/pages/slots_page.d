...
{
    return [
        Group("text", [Slot.inherit, Slot.textPrimary, Slot.textSecondary,
            Slot.muted, Slot.textDisabled, Slot.textInverse, Slot.code,
            Slot.docs, Slot.matched, Slot.unmatched]),
        Group("status", [Slot.error, Slot.warn, Slot.info, Slot.success,
            Slot.annotate]),
        Group("surfaces", [Slot.surfaceBase, Slot.surfaceRaised, Slot.surface,
            Slot.surfaceSunken, Slot.border, Slot.borderStrong, Slot.borderFocus,
            Slot.shadow, Slot.chip, Slot.highlight, Slot.highlightBorder,
            Slot.hoverUnderline, Slot.caret]),
        Group("accent", [Slot.accentPrimary, Slot.accentSecondary, Slot.link,
            Slot.focusRing, Slot.selection]),
