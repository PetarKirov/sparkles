...
These parsers return $(REF ParseExpected, sparkles,base,text,errors), whose
$(REF ParseError, sparkles,base,text,errors) carries a scheme-agnostic
$(REF ParseErrorCode, sparkles,base,text,errors). To surface the
...
$(REF ParseErrorCode, sparkles,base,text,errors) is `invalidIdentifier`, the
...
pinned $(REF ParseExpected, sparkles,base,text,errors) return type.
*/
