...
failures via $(REF ParseExpected, sparkles,base,text,errors).
...
$(OL
    $(LI the version line — `age-encryption.org/v1\n` exactly. Any other version
        ...
        $(REF ParseErrorCode.invalidIdentifier, sparkles,base,text,errors)
...
$(REF ParseError, sparkles,base,text,errors)`.offset` is relative to
...
if (isOutputRange!(W, const(char)[]))
{
    ...
    UniqueBuffer!(char, base64EncodedLength(headerMacBytes)) macChars;
