...
private string parseCodeText(ParseErrorCode code) @safe pure nothrow @nogc
{
    ...
    // Base16/32/64 codes (`text.base_codecs`): part of the shared vocabulary,
    // never produced by the JSON reader — named so this stays a `final switch`.
    case nonCanonicalTrailing:
